<x-app-layout>
    ...
    <div class="bg-white">
        <div class="max-w-screen-lg p-5 mx-auto">
            <div class="grid grid-cols-1 border md:grid-cols-12">
                <div class="p-10 text-teal-600 bg-teal-100 md:col-span-4">
                    <p class="mt-4 text-sm leading-7 uppercase font-regular">
                        اتصل بنا
                    </p>
                    <h3 class="text-3xl font-extrabold leading-normal tracking-tight sm:text-4xl">
                        تواصل <span class="text-teal-700">معنا</span>
                    </h3>
                    <p class="mt-4 leading-7 text-teal-400">
                        النص التالي هو نص تجريبي لصناعة الطباعة وتنسيق النصوص. كان النص التجريبي يستخدم بشكل قياسي في
                        الصناعة منذ القرن الخامس عشر.
                    </p>
                    <div class="flex items-center mt-5">
                        <svg class="h-6 mx-2 text-teal-500" fill="currentColor" version="1.1"
                        ...
                        <span class="text-sm">البيت #14 .</span>
                    </div>

                    <div class="flex items-center mt-5">
                        <svg class="h-6 mx-2 text-teal-600" fill="currentColor" version="1.1" id="Capa_1"
      ...
      c0.067,0.04,6.778,4.003,8.521,7.296C52.202,48.062,51.994,49.447,51.078,50.363z">
                    ...
                    <div class="flex items-center mt-5">
                        <svg class="h-6 mx-2 text-teal-500" fill="currentColor" version="1.1" id="Capa_1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                ...
                <form action="https://fabform.io/f/{form-id}" method="post" class="p-10 md:col-span-8">
                    <div class="flex flex-wrap mb-6 -mx-3">
                        <div class="w-full px-3 mb-6 md:w-1/2 md:mb-0">
                            <label class="block mb-2 text-xs font-bold tracking-wide text-teal-500 uppercase"
                                for="grid-first-name">
                                الاسم الأول
                            </label>
                            <input
                                class="block w-full px-4 py-3 mb-3 leading-tight text-gray-700 border border-blue-300 rounded appearance-none bg-blue-50 focus:outline-none focus:bg-white"
                                id="grid-first-name" type="text" placeholder=" الاسم الأول">
                        ...
                        <div class="w-full px-3 md:w-1/2">
                            ...
                            <input
                                class="block w-full px-4 py-3 leading-tight text-gray-700 border border-blue-300 rounded appearance-none bg-blue-50 focus:outline-none focus:bg-white focus:border-blue-500"
                                id="grid-last-name" type="text" placeholder=" الاسم الأخير">
                    ...
                    <div class="flex flex-wrap mb-6 -mx-3">
                        <div class="w-full px-3">
                            ...
                            <input
                                class="block w-full px-4 py-3 mb-3 leading-tight text-gray-700 border border-blue-300 rounded appearance-none bg-blue-50 focus:outline-none focus:bg-white focus:border-blue-500"
                                id="grid-email" type="email" placeholder="example@domain.com">
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap mb-6 -mx-3">
                        <div class="w-full px-3">
                            ...
                            <textarea rows="10"
                                class="block w-full px-4 py-3 mb-3 leading-tight text-gray-700 border border-blue-300 rounded appearance-none bg-blue-50 focus:outline-none focus:bg-white focus:border-blue-500"></textarea>
                        </div>
                        <div class="flex justify-between w-full px-3">
                            <div class="md:flex md:items-center">
                                <label class="block font-bold text-gray-500">
                                    <input
                                        class="mr-2 leading-tight border round-full rounded-full border-2 border-teal-600 bg-white transition-all duration-300 peer-checked:bg-teal-600 peer-checked:border-teal-600 peer-checked:after:content-['✔'] peer-checked:after:text-white peer-checked:after:absolute peer-checked:after:left-2 peer-checked:after:top-1.5 peer-checked:after:text-2xl"
                                        type="checkbox">
                                    <span class="text-sm text-teal-500">
                                        أرسل لي النشرة الإخبارية!
                                    </span>
                                </label>
                            </div>

                            <button
                                class="px-6 py-2 font-bold text-white bg-teal-500 rounded shadow hover:bg-teal-400 focus:shadow-outline focus:outline-none"
                                type="submit">
                                إرسال الرسالة
                            </button>
                        </div>
                        <a href="https://veilmail.io/e/FkKh7o" class="font-medium text-blue-600 hover:underline">أو اضغط
                            هنا للكشف عن عنوان بريدنا الإلكتروني المحمي</a>
                    </div>
                </form>
